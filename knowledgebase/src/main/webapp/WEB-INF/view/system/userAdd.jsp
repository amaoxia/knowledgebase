...
<head>
	<%@include file="/common/taglibs.jsp"%>
		<link rel="stylesheet" type="text/css" href="<%=ctx%>/js/jquery/jquery-easyui-1.2.6/themes/default/easyui.css" />
		<link rel="stylesheet" type="text/css" href="<%=ctx%>/js/jquery/jquery-easyui-1.2.6/themes/icon.css" />
		<link rel="stylesheet" type="text/css" href="<%=ctx%>/js/jquery/jquery-easyui-1.2.6/themes/demo.css"/>
		<script type="text/javascript" src="<%=ctx%>/js/jquery/lib/jquery-1.7.2.min.js"></script>
		<script type="text/javascript" src="<%=ctx%>/js/jquery/jquery-easyui-1.2.6/jquery.easyui.min.js"></script>
...
<input type = "hidden" id="provinceid" name="user.provinces">
                ...
                <tr>
                  ...
                  <td width="70" style="cursor:hand" onMouseOver="this.style.backgroundImage='url(images/tool_bg1.gif)';this.style.borderStyle='solid';this.style.borderWidth='1';borderColor='#DFAF0D'; "onmouseout="this.style.backgroundImage='url()';this.style.borderStyle='none'">
                      ...
                      <tr>
                        ...
                        <td><a href="#" onlick="onReset();">重置</a></td>
                      </tr>
                    </table>
                  </td>
                  <td width="70" style="cursor:hand" onMouseOver="this.style.backgroundImage='url(images/tool_bg1.gif)';this.style.borderStyle='solid';this.style.borderWidth='1';borderColor='#DFAF0D'; "onmouseout="this.style.backgroundImage='url()';this.style.borderStyle='none'">
                ...
                <tr>
                  <td>
                  	<div  style="padding-top:10px; padding-bottom:10px;">
                   	<table width="90%" border="0" align="center" cellpadding="0" cellspacing="2" class="edittb">
						<tr align="center" onmouseout="reChangeBackground(this)" onmouseover="changeBackground(this)">
							...
							<td class="result_content" width="70%" align="left">&nbsp;&nbsp;&nbsp;&nbsp;
								<input type = "text" id="useraccount" name="user.loginuser" style="width:200px;">
							</td>
				      	</tr>
				      	<tr align="center" onmouseout="reChangeBackground(this)" onmouseover="changeBackground(this)">
							<td class="result_content" width="30%" align="center">登录密码<font style="color:red">(*)</font></td>
							<td class="result_content" width="70%" align="left">&nbsp;&nbsp;&nbsp;&nbsp;
								<input type = "password" id="loginpwd" name="user.loginpwd" style="width:200px;">
							</td>
				      	</tr>
				      	<tr align="center" onmouseout="reChangeBackground(this)" onmouseover="changeBackground(this)">
							<td class="result_content" width="30%" align="center">确认密码<font style="color:red">(*)</font></td>
							<td class="result_content" width="70%" align="left">&nbsp;&nbsp;&nbsp;&nbsp;
								<input type = "password" id="upwd" name="upwd" style="width:200px;">
							</td>
				      	</tr>
				      	<tr align="center" onmouseout="reChangeBackground(this)" onmouseover="changeBackground(this)">
							<td class="result_content" width="30%" align="center">员工姓名<font style="color:red">(*)</font></td>
							<td class="result_content" width="70%" align="left">&nbsp;&nbsp;&nbsp;&nbsp;
								<input type = "text" id="username" name="user.username" style="width:200px;">
							</td>
				      	</tr>
				      	<tr align="center" onmouseout="reChangeBackground(this)" onmouseover="changeBackground(this)">
							<td class="result_content" width="30%" align="center">员工编号<font style="color:red">(*)</font></td>
							<td class="result_content" width="70%" align="left">&nbsp;&nbsp;&nbsp;&nbsp;
								<input type = "text" id="usercode" name="user.usercode" style="width:200px;">
							</td>
				   		</tr>
				   		<tr align="center" onmouseout="reChangeBackground(this)" onmouseover="changeBackground(this)">
							<td class="result_content" width="30%" align="center">所属机构<font style="color:red">(*)</font></td>
							<td class="result_content" width="70%" align="left">&nbsp;&nbsp;&nbsp;&nbsp;
							<input type = "text" id="orgname" name="user.orgname" style="width:200px;" readonly="true">
				   		...
				   		<tr align="center" onmouseout="reChangeBackground(this)" onmouseover="changeBackground(this)">
							...
							<td  width="70%" align="left">&nbsp;&nbsp;&nbsp;&nbsp;
								<select id="usertype" name="user.usertype" style="width:200px;" >
									...
									<option value ="3">区域商务人员</option>
									<option value ="4">中央商务人员</option>
								</select>
							</td>
				   		</tr>
				   		<tr align="center" onmouseout="reChangeBackground(this)" onmouseover="changeBackground(this)" id="provinceclass" style="display:none">
							...
							<td class="result_content" width="70%" align="left">&nbsp;&nbsp;&nbsp;&nbsp;
							<input type = "hidden" id="orgid" name="user.orgid">
							<input type = "text" id="provincename" name="user.provincename" style="width:200px;" readonly="true">
						...
						<tr align="center" onmouseout="reChangeBackground(this)" onmouseover="changeBackground(this)">
							...
							<td class="result_content" width="70%" align="left">&nbsp;&nbsp;&nbsp;&nbsp;
								<input type = "text" id="useremail" name="user.useremail" style="width:200px;">
							</td>
						</tr>
				   		<tr align="center" onmouseout="reChangeBackground(this)" onmouseover="changeBackground(this)">
							...
							<td class="result_content" width="70%" align="left">&nbsp;&nbsp;&nbsp;&nbsp;
								...
								<input type="radio" name="rdosex" value="1" checked="true" onclick="setHiddenValue('usersex',this.value)">男&nbsp;&nbsp;
								<input type="radio" name="rdosex" value="2" onclick="setHiddenValue('usersex',this.value)">女
							</td>
				   		</tr>
				   		<tr align="center" onmouseout="reChangeBackground(this)" onmouseover="changeBackground(this)">
							<td class="result_content" width="30%" align="center">电话</td>
							<td class="result_content" width="70%" align="left">&nbsp;&nbsp;&nbsp;&nbsp;
								<input type = "text" id="usertel" name="user.usertel" style="width:200px;">
							</td>
				   		</tr>
				   		<tr align="center" onmouseout="reChangeBackground(this)" onmouseover="changeBackground(this)">
							<td class="result_content" width="30%" align="center">手机</td>
							<td class="result_content" width="70%" align="left">&nbsp;&nbsp;&nbsp;&nbsp;
								<input type = "text" id="usermp" name="user.usermp" style="width:200px;">
							</td>
			    		</tr>
			    		<tr align="center" onmouseout="reChangeBackground(this)" onmouseover="changeBackground(this)">
							<td class="result_content" width="30%" align="center">QQ</td>
							<td class="result_content" width="70%" align="left">&nbsp;&nbsp;&nbsp;&nbsp;
								<input type = "text" id="userqq" name="user.userqq" style="width:200px;">
							</td>
				     	</tr>
				     	<tr align="center" onmouseout="reChangeBackground(this)" onmouseover="changeBackground(this)">
							<td class="result_content" width="30%" align="center">MSN</td>
							<td class="result_content" width="70%" align="left">&nbsp;&nbsp;&nbsp;&nbsp;
								<input type = "text" id="usermsn" name="user.usermsn" style="width:200px;">
							</td>
				   		</tr>
				  </table>
            </div>
...
<script language="javascript">
			...
			showErrors: showErrors, 
   	  		rules: {    
	  			  'user.loginuser': {                 
		       	  	...
		       	  	maxlength:64,
		       	  	remote:{
		                   url:'<%=ctx%>/sys/userCheck.htm?currTime='+new Date(),
		                   type:"post",
		                   dataType:"json",
		                   data:{loginuser:function(){return $('#loginuser').val()}}          
       		 		}
		       	  },     
		       	  'user.username': {                 
		       	  	required: true,
	...
	function doSubmit() {
		...
		document.forms[0].action="<%=ctx%>/sys/userAdd.htm";
		$("#addform").submit();
	}
	function toGoBack() {	
