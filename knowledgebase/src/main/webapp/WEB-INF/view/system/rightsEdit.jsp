...
<html>
	...
	<body>
		<s:form action="siteinfo" method="post">
			<input type="hidden" name="pagerAction"
				value="siteinfo!execute.action">
					...
					<td colspan="2">
						<table class="query">
							<tr height="22">
								...
								<TD width="20%">
									<s:textfield id="siteName" name="siteInfo.tiSsitename"
										cssClass="mytext" theme="simple" />
								</TD>
								<TD width="10%">
									&nbsp;
								</TD>
							...
							<tr>
								<td colspan="6" style="text-align: right;">
									<input type="submit" name="cmdquery" value="查询"
										class="mybutton">
									<input type="button" name="cmdadd" value="新增" class="mybutton"
										onclick="doEdit(1)">
								</td>
							</tr>
						</table>

						<div width="100%" height="1">
							&nbsp;
						</div>
						...
						<div class="resultDiv">
							<table width="100%" border="0" cellpadding="0" cellspacing="0"
								...
								<tr align="center" class="result_head">
									...
									<td nowrap class="result_head_dock" width="5%">
										序号
									</td>
									<td nowrap class="result_head_dock" width="15%">
										网站名称
									</td>
									<td nowrap class="result_head_dock" width="10%">
										网站类型
									</td>
									<td nowrap class="result_head_dock" width="20%">
										网址
									</td>
									<td nowrap class="result_head_dock" width="15%">
										IP
									</td>
									<td nowrap class="result_head_dock" width="12%">
										作者
									</td>
									<td nowrap class="result_head_dock" width="10%">
										创建时间
								...
								<s:iterator value="#request.pagerResult.items" id="pageResult"
									status="status">
									<tr align="center" onmouseout="reChangeBackground(this)"
										...
										<td nowrap class="result_content">
											<a href="javascript:doSearchSiteView()"><s:property
													value="tiSsitename" />
											</a>
										</td>
										<td nowrap class="result_content">
											&nbsp;
											<s:property value="siteType" />
										</td>
										<td nowrap class="result_content">
											&nbsp;
											<s:property value="tiSurl" />
										</td>
										<td nowrap class="result_content">
											&nbsp;
											<s:property value="tiSip" />
										</td>
										<td nowrap class="result_content">
											&nbsp;
										...
										<td nowrap class="result_content">
											<img src="<%=scontext%>/admin/images/modily.gif"
												onclick="doEdit(2)" alt="修改">
											&nbsp;&nbsp;
											<img src="<%=scontext%>/admin/images/delete.gif"
												onclick="doEdit(3)" alt="删除">
										</td>
									</tr>
								</s:iterator>
							</table>
