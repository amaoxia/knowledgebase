...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		<form action="/sys/doAddOrg.htm" name="form1" id="form1" method="post">
						...
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							<tr>
								<td align="right" valign="top" class="czmb_2">
									<div class="tool" <c:if test="${not empty param.parentcode }">style="display:none;"</c:if>>
											...
											<tr>
												<td width="70" height="27" style="cursor: hand"
													...
													<table width="100%" border="0" cellpadding="0" cellspacing="0">
														<tr>
															<td align="center">
																<img src="<%=ctx%>/images/back.gif" width="22"
																	height="21">
															</td>
															<td>
												...
												<td width="70" style="cursor: hand"
													...
													<table width="100%" border="0" cellpadding="0" cellspacing="0">
														<tr>
															<td align="center">
																<img src="<%=ctx%>/images/cz.gif" width="22" height="21">
															</td>
															<td>
												...
												<td width="70" style="cursor: hand"
													...
													<table width="100%" border="0" cellpadding="0"
														...
														<tr>
															<td align="center">
																<img src="<%=ctx%>/images/tj.gif" width="22" height="21">
															</td>
															<td>
												...
												<table width="98%" border="0" align="center" cellpadding="0"
													...
													<tr>
														...
														<td width="38%" align="right">
															<img src="<%=ctx%>/images/zk.gif" width="15" height="14">
														</td>
													</tr>
												</table>
											</td>
													...
													<table width="90%" border="0" align="center"
														...
														<tr align="center" onmouseout="reChangeBackground(this)"
															...
															<td width="70%" align="left">
																&nbsp;&nbsp;&nbsp;&nbsp;
																<input id="orgcode" name="orgcode" style="width:200px; margin-left:2px;"/>
															</td>
														</tr>
														...
														<tr align="center" onmouseout="reChangeBackground(this)" onmouseover="changeBackground(this)">
															...
															<td width="70%" align="left">
																&nbsp;&nbsp;&nbsp;&nbsp;
																<input id="orgname" name="orgname" style="width:200px; margin-left:2px;" />
															</td>
														</tr>
														<tr align="center" onmouseout="reChangeBackground(this)" onmouseover="changeBackground(this)">
															<td width="30%" align="center">
															...
															<td width="70%" align="left">
																&nbsp;&nbsp;&nbsp;&nbsp;
																<input id="orgasname" name="orgasname" style="width:200px; margin-left:2px;"/>
															</td>
														</tr>
														<tr align="center" onmouseout="reChangeBackground(this)" onmouseover="changeBackground(this)">
															<td width="30%" align="center">
															...
															<td width="70%" align="left">
																&nbsp;&nbsp;&nbsp;&nbsp;
																<input id="orgtel" name="orgtel" style="width:200px; margin-left:2px;"/>
															</td>
														</tr>
														<tr align="center" onmouseout="reChangeBackground(this)" onmouseover="changeBackground(this)">
															<td width="30%" align="center">
															...
															<td width="70%" align="left">
																&nbsp;&nbsp;&nbsp;&nbsp;
																<input id="orgfax" name="orgfax" style="width:200px; margin-left:2px;"/>
															</td>
														</tr>
														<tr align="center" onmouseout="reChangeBackground(this)" onmouseover="changeBackground(this)">
															<td width="30%" align="center">
															...
															<td width="70%" align="left">
																&nbsp;&nbsp;&nbsp;&nbsp;
																<input id="orgaddress" name="orgaddress" style="width:500px; margin-left:2px;"/>
															</td>
														</tr>
													</table>
												</div>
...
<script language="javascript">
		...
		var options = {
			...
			success: function(responseText, statusText) {	
				if(!(responseText.success)) {
					...
					var parentcode = "${param.parentcode }";
					if(parentcode){
						alert("保存成功！");
						parent.treeReload();
					}else{
	...
	function doSubmit(){
		$('#form1').attr("action","<%=ctx%>/sys/doAddOrg.htm");
	    $('#form1').submit();
	}
