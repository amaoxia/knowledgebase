                  ...
                  <td>                  	
				      ...
				      <tr align="center" onmouseout="reChangeBackground(this)" onmouseover="changeBackground(this)">
						...
						<td class="result_content" width="70%" align="left">&nbsp;&nbsp;&nbsp;&nbsp;
							<input type = "text" id="dictkey" name="dictkey" value="${dictkey}" cssClass="mytext" theme="simple">
						</td>
				      </tr>
				      <tr align="center" onmouseout="reChangeBackground(this)" onmouseover="changeBackground(this)">
						<td class="result_content" width="30%" align="center">字典名称<font style="color:red">(*)</font></td>
						<td class="result_content" width="70%" align="left">&nbsp;&nbsp;&nbsp;&nbsp;
							<input type = "text" id="dictname" name="dictname" value="${dictname}" cssClass="mytext" theme="simple">
						</td>
				      </tr>
				      <tr align="center" onmouseout="reChangeBackground(this)" onmouseover="changeBackground(this)">
						<td class="result_content" width="30%" align="center">备注</td>
						<td class="result_content" width="70%" align="left">&nbsp;&nbsp;&nbsp;&nbsp;
							<input type = "text" id="descinfo" name="descinfo" value="${descinfo}" cssClass="mytext" theme="simple">
						</td>
				      </tr>
				      </table>
	                </div>
...
<script language="javascript">
			...
			showErrors: showErrors, 
   	  		rules: {    
	  			  'dictkey': {                 
		       	  	...
		       	  	maxlength:45,
		       	  	remote:{
		                   url:'<%=ctx%>/sys/dictCheck.htm?currTime='+new Date(),
		                   type:"post",
		                   dataType:"json",
		                   data:{dictkey:function(){return $('#dictkey').val()}}          
       		 		}
		       	  },     
		       	  'dictname': {                 
		       	  	required: true,
	...
	function doSubmit() {
		...
		document.forms[0].action="<%=ctx%>/sys/dictAdd.htm";
		$("#addform").submit();
	}
	function toGoBack() {	
