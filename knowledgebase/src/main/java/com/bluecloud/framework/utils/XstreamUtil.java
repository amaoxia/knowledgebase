...
public final class XstreamUtil {
	...
	public static void toXmlFromObject(String asname, Object obj,
			String sclassname, String savefilename) throws Exception {
		if (obj == null)
			return;
		FileOutputStream fs = null;
		try {
			// getXstream().aliasField(asname,
			// Class.forName(sclassname),asname);
	 ...
	 * @throws Exception
	 */
	public static void toXmlFromList(List list, String sclassname,
	 ...
	 * @throws Exception
	 */
	public static List toListFromXml(String filename, String sclassname)
			throws Exception {
		List list = null;
	...
	public static Object toObjectForXml(List list, String sclassname)
			throws Exception {
		Object obj = null;
		return obj;
	}
